...
if (!defined('__CLASS_QRCODE__'))
{
	 ...
	 */
		public function outputCustomPng($w = 100, $background = [255, 255, 255], $color = [0, 0, 0], $compression = 0)
		{
			$qrSize = $this->getQrSize();
			$final = $this->getFinal();
		...
		public function outputCustomHtml($w = 10)
		{
			$s = '';
			...
			$s .= '<table class="qr" cellpadding="0" cellspacing="0" style="font-size: 1px; width: 100%; height: 100%;">' . "\n";
